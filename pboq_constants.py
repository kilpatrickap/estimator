...
COLOR_HEADER_TEXT = QColor("#0000FF") # Pure blue for headers
...
COL_COLOR_ORANGE = QColor("#ffe0b2") # Light Orange for Subcontractor Rates
...
# Stats Colors
COLOR_STATS_BLUE = QColor("#0000FF")
COLOR_STATS_GREEN = QColor("#388E3C")
COLOR_STATS_RED = QColor("#FF0000")
COLOR_FREEZE_GRAY = QColor("#9E9E9E")
COLOR_FREEZE_GREEN = QColor("#2E7D32")
COLOR_FREEZE_YELLOW = QColor("#FFEB3B")
COLOR_FLAGGED = QColor("#FFCDD2")  # Soft red for flagged items
