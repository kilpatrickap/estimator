        ...
        html += f"""
            <div style="page-break-inside: avoid; margin-top: 30px;">
                ...
                <table style="width: 60%; margin-left: auto; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="font-size: 18px; font-weight: bold; color: #2e7d32; padding-top: 10px;">GRAND TOTAL :</td>
                        <td style="font-size: 18px; font-weight: bold; color: #2e7d32; padding-top: 10px; text-align: right;">{symbol}{totals['grand_total']:,.2f}</td>
                    </tr>
                </table>
            </div>
