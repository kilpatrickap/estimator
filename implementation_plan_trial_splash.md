...
8.  **Verify Checkout Simulation:** Click "Upgrade" from any failed state, click "Activate Green Pass (Simulation)", verify the success message, and confirm the app now opens immediately as a premium Paid License user.
